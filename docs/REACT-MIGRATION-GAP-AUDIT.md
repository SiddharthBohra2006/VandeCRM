...
4. **4.2 "Hot Lead" badge** — ✅ RESOLVED: no per-row badge exists. "Hot"/`hotLeads` is only a summary KPI (high-potential count) at EJS `index.ejs:761`, already fully ported in `CustomersPage.tsx:261-262`.
